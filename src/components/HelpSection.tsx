    ...
    return (
        <div className="">
            <div className="flex flex-col mb-7">
                <h2 className="text-4xl self-center font-bold mb-4 bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text">How to Use the Application</h2>
